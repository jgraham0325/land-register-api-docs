...
* The WRN is generated in the following format: {SWA prefix} {workstream prefix} {promoter works reference}
  ...
  * **Workstream prefix** - Consists of a minimum of three numbers with leading zeros where applicable e.g. '001'. See the workstream section for more details.
  * **Promoter works reference** - Between 1 to 19 characters generated by the Street Manager system or provided by the user. If generated by Street Manager, the promoter works reference will consist of a randomly generated 8-digit number (following WRN unique rule).
