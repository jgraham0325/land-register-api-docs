---
layout: article
title: Business rules - version 1.21
date: 2020-05-11T09:36:02.738Z
type: article
published: 'true'
status: publish
---
...
<span class="govuk-body-l" style="float:left">Version 1.21 (Due for release to sandbox 14/05/20)</span>
...
| ---------------------------------- | -------------------------------------------------------- |
| 3.4.4. Work activity types | Updated to remove the tag "(Planned for future)" as these activities have now been added |
